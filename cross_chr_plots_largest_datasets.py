...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 11 14:02:25 2025

@author: eta

With largest data (created using generate_dnabert_datasets_faster.py),
make cross-chr analysis
Predictions, Plots
"""
...
def train17_test14_dnabert(file_train, file_test, path):
    ...
    # Define the model
    model = RandomForestRegressor(n_estimators=20, max_features=0.3, random_state=42, bootstrap=True, n_jobs=100)
...
def pearson_plots_train17_test14_dnabert_gm12878(path_dnabert, path_control, save_path):
    ...
    # Set grid with intervals of 0.5
    plt.xticks([0, 0.5, 1])
...
def main():
    ...
    '''
    import os
    base_path_predictions = '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/largest_authors_dataset_with_dnabert_features/predictions_plots'
    base_path_predictions_2 = '/sybig/home/eta/Masterthesis/scripts/dnabert_datasets/largest/predictions_plots'
    # authors dataset
    ...
    '''
    # authors dataset
    train17_test14_dnabert(file_path_authors_1, file_path_authors_2, path1)
    train17_test14_dnabert(file_path_authors_3, file_path_authors_4, path2)
    train17_test14_dnabert(file_path_authors_5, file_path_authors_6, path3)
    train17_test14_dnabert(file_path_authors_7, file_path_authors_8, path4)
    train17_test14_dnabert(file_path_authors_9, file_path_authors_10, path5)
    
    #control
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Gm12878_chr17_feature.csv', '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Gm12878_chr14_feature.csv', path6)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/K562_chr17_feature.csv', '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/K562_chr14_feature.csv', path7)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Hmec_chr17_feature.csv', '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Hmec_chr14_feature.csv', path8)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Huvec_chr17_feature.csv', '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Huvec_chr14_feature.csv', path9)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Nhek_chr17_feature.csv', '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/txt_to_csv_window/Nhek_chr14_feature.csv', path10)
    
    
    # my dataset
    train17_test14_dnabert(file_path_mine_1, file_path_mine_2, path11)
    train17_test14_dnabert(file_path_mine_3, file_path_mine_4, path12)
    train17_test14_dnabert(file_path_mine_5, file_path_mine_6, path13)
    train17_test14_dnabert(file_path_mine_7, file_path_mine_8, path14)
    train17_test14_dnabert(file_path_mine_9, file_path_mine_10, path15)
    #control
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Gm12878_chr17_pair_concat.csv', '/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Gm12878_chr14_pair_concat.csv', path16)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/K562_chr17_pair_concat.csv', '/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/K562_chr14_pair_concat.csv', path17)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Hmec_chr17_pair_concat.csv', '/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Hmec_chr14_pair_concat.csv', path18)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Huvec_chr17_pair_concat.csv', '/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Huvec_chr14_pair_concat.csv', path19)
    train17_test14_dnabert('/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Nhek_chr17_pair_concat.csv', '/sybig/home/eta/Masterthesis/scripts/make_new_datasets_from_scratch/pair_concat_features/pair_concat_features/Nhek_chr14_pair_concat.csv', path20)
    '''
    # base_path_predictions = '/sybig/home/eta/Masterthesis/scripts/dataset_analysis/expand_authors_dataset_dnabert/largest_authors_dataset_with_dnabert_features/predictions_plots'
    # base_path_predictions_2 = '/sybig/home/eta/Masterthesis/scripts/dnabert_datasets/largest/predictions_plots'
    # predictions_authors_pc_Gm12878_dnabert_train17_test14.csv
    
    # authors dataset
    pearson_plots_train17_test14_dnabert_gm12878(path1, path6, os.path.join(base_path_predictions, 'pearson_plot_authors_train17_test14_gm12878_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_K562(path2, path7, os.path.join(base_path_predictions, 'pearson_plot_authors_train17_test14_K562_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Hmec(path3, path8, os.path.join(base_path_predictions, 'pearson_plot_authors_train17_test14_Hmec_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Huvec(path4, path9, os.path.join(base_path_predictions, 'pearson_plot_authors_train17_test14_Huvec_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Nhek(path5, path10, os.path.join(base_path_predictions, 'pearson_plot_authors_train17_test14_Nhek_pc_dnabert.png'))
    
    # my dataset
    pearson_plots_train17_test14_dnabert_gm12878(path11, path16, os.path.join(base_path_predictions_2, 'pearson_plot_mine_train17_test14_gm12878_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_K562(path12, path17, os.path.join(base_path_predictions_2, 'pearson_plot_mine_train17_test14_K562_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Hmec(path13, path18, os.path.join(base_path_predictions_2, 'pearson_plot_mine_train17_test14_Hmec_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Huvec(path14, path19, os.path.join(base_path_predictions_2, 'pearson_plot_mine_train17_test14_Huvec_pc_dnabert.png'))
    pearson_plots_train17_test14_dnabert_Nhek(path15, path20, os.path.join(base_path_predictions_2, 'pearson_plot_mine_train17_test14_Nhek_pc_dnabert.png'))
